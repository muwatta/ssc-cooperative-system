...
from .views import FinancialSnapshotView, MonthlyDeductionsReportView
...
urlpatterns = [
    ...
    path('monthly-deductions/', MonthlyDeductionsReportView.as_view(), name='monthly-deductions'),
]